...
from image_inpainting.dataset.image_net_dataset import ImageNetDataset
...
class ImageNetDataModule(pl.LightningDataModule):
    ...
    def __init__(self, data_dir="../../data/imagenet", batch_size_train=32, batch_size_val=32, batch_size_test=32, num_workers=0, pin_memory=False, persistent_workers=False):
        """Initializes ImageNetDataModule.
        
        Args:
            data_dir (str, optional): Path to the ImageNet dataset directory. Defaults to "../../data/imagenet".
    ...
    def inverse_transform(self, x):
        ...
        Returns:
            np.ndarray: Inverse transformed image.
        """ 
    ...
    def setup(self, stage: str):
        """Set up the ImageNet dataset.
        
        Args:
            stage (str): Stage of the data setup (either "fit" for training and validation data or "test" for test data).
        """
